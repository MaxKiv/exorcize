...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    # AssertionError: 1071000.0 != 8568 : Called exchangeable_value(100000, 10.61, 10, 1). The function returned 1071000.0, but The tests expected
    # 8568 as the maximum value of the new currency .
